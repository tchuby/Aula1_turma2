...
namespace ListandoPessoas2.Controller
{
    ...
    {
        /// <summary>
        /// Lista que contem as pessoas para realiar as atividades
        /// </summary>
        ...
        public PessoaController()
        {
            ...
            #region Escondendo a base de informações
        ...
        /// com essa propriedade temos a lista completae sem regras
        ...
        /// <summary>
        /// Metodo que retorna a lista de pessoas com idade maior que a idade informada
        /// caso não informada o valor padrão é 18
        /// </summary>
        ...
        /// <summary>
        /// Metodo que retorna idade menor que idade informada por parâmetro
        /// neste caso paramentro não informado o valor padrão é 16
        /// </summary>
        /// <param name="idade">parametro da idade</param>
        /// <returns>Retorna a lista apenas com os valores menosres que</returns>
