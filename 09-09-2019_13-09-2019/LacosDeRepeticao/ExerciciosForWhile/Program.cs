...
namespace ExerciciosForWhile
{
    class Program
    {
        ...
        /// <summary>
        /// Metodo de buscar a palavra pela funcao for
        /// </summary>
        /// <param name="wordFind">Sem parâmetro de caracteres</param>
        ...
        private static int FindByFor(string wordFind)
        {
            ...
            var wordFindeCountLength = wordFind.Length;
            var lengthText = contentToFind.Length - (wordFindeCountLength - 1);
            var contWordFind = 0;
            var i = 0;
